...
This installs the latest release. With root privileges, installs to
`/opt/tapa` (symlinks in `/usr/local/bin`). Without root, installs to `~/.tapa`
and updates your shell `PATH`.
