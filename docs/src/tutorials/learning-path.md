...
| [Lab 6: Floorplan & DSE](lab-06-floorplan.md) | Floorplanning for multi-SLR FPGAs _(temporarily unavailable — being reworked)_ | Lab 2 | 60 min | — |
...
**Need HBM throughput** — Work through Lab 2 (async\_mmap) for memory throughput. (Floorplanning for multi-SLR devices, formerly Lab 6, is being reworked and is temporarily unavailable.)
