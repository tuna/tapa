...
Welcome to the `TAPA`_ documentation. TAPA is a powerful framework for
designing high-frequency FPGA dataflow accelerators. It provides a robust
C++ API for expressing task-parallel designs with advanced optimization
techniques to deliver exceptional design performance and productivity.
