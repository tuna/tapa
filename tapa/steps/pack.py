...
@click.option(
    ...
    required=False,
    help=(
        "Output packed artifact. "
        "For xilinx-vitis target: a .xo Xilinx object file. "
        "For xilinx-hls target: a .zip RTL archive."
    ),
)
@click.option(
    "--bitstream-script",
...
@click.option(
    ...
    "generated by TAPA. "
    ".v files are format-checked against expected port signatures; "
    "other file types (.tcl, etc.) are accepted and packaged without format checking. "
    'Use [[tapa::target("ignore")]] to generate the'
