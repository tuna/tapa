...
void read_edge_list_ptr(const tapa::u<32> num_ite, const tapa::u<32> M,
                        ...
                        tapa::mmap<tapa::u<32>> edge_list_ptr,
...
void read_A(tapa::mmap<tapa::u<512>> A, tapa::ostream<tapa::u<512>>& fifo_A,
            const tapa::u<32> A_len, const tapa::u<16> rp_time) {
l_rp:
  [[tapa::tripcount(1, 16)]] [[tapa::flatten(false)]] for (tapa::u<16> rp = 0;
                                                           rp < rp_time; rp++) {
  rd_A:
    [[tapa::pipeline(1)]] [[tapa::tripcount(1, 10000)]] for (tapa::u<32> i = 0;
                                                             i < A_len; i++) {
...
void read_X(tapa::mmap<tapa::u<512>> X, tapa::ostream<tapa::u<512>>& fifo_X,
            const tapa::u<32> K, const tapa::u<16> rp_time) {
...
l_rp:
  [[tapa::tripcount(1, 16)]] [[tapa::flatten(false)]] for (tapa::u<16> rp = 0;
                                                           rp < rp_time; rp++) {
  rd_X:
    [[tapa::pipeline(1)]] [[tapa::tripcount(1, 500000)]] for (tapa::u<32> i = 0;
                                                              i < num_ite_X;
                                                              i++) {
...
void read_Y(tapa::mmap<tapa::u<512>> Y_in, tapa::ostream<tapa::u<512>>& fifo_Y,
            const tapa::u<32> M, const tapa::u<16> rp_time) {
